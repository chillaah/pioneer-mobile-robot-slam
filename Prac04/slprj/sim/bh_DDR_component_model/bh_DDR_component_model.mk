...
MODEL                   = bh_DDR_component_model
MODULES                 = bh_DDR_component_model.c bh_DDR_component_model_capi.c
PRODUCT                 = bh_DDR_component_modellib.a
MAKEFILE                = bh_DDR_component_model.mk
MATLAB_ROOT             = /Applications/MATLAB_R2021a.app
ALT_MATLAB_ROOT         = /Applications/MATLAB_R2021a.app
START_DIR               = /Users/chilla/Desktop/pioneer-mobile-robot-slam/Prac04
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 5
COMPUTER                = MACI64
BUILDARGS               =  GENERATE_ERT_S_FUNCTION=0 GENERATE_ASAP2=0 EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 OPTS="-DIS_SIM_TARGET -DMATLAB_MEX_FILE -DTID01EQ=0" MACOSX_VERSION_MIN_FLAG="-mmacosx-version-min=10.14"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ALLOCATIONFCN           = 0
...
COMPILE_FLAGS_OTHER     = 
SYSTEM_LIBS             = -L"/Applications/MATLAB_R2021a.app/bin/maci64" -lfixedpoint -lmwmathutil -lmwipp -lmwsl_AsyncioQueue -lmwsf_runtime -lmwslexec_simlog -lmwcoder_ToAsyncQueueTgtAppSvc -lmwsl_simtarget_instrumentation -lmwsl_simtarget_core -lmwstringutil
...
MODELLIB                  = bh_DDR_component_modellib.a
MODELREF_LINK_LIBS        = 
...
ADD_INCLUDES = \
	-I$(START_DIR) \
	-I$(START_DIR)/slprj/sim/bh_DDR_component_model \
